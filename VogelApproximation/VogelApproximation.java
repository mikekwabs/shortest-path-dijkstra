...
public class VogelApproximation {
    ...
    final static int[] demand = { 325, 425, 475, 275 };
    final static int[] supply = { 400, 500, 600 };
    final static int[][] costs = { { 8, 6, 12, 9 }, { 7, 11, 10, 14 }, { 13, 8, 8, 7 } };
